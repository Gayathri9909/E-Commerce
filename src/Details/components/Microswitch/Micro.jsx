...
export default function Micro() {
  ...
  const MicroProducts= product.filter((data)=>data.category === "Microswitch")
  console.log("MicroProducts",MicroProducts);
  function addeditem(){
    nav('/Cartadd')
  }
  ...
  return (
    <div className="main">
      ...
      <h1 className="be" >MICRO SWITCHES</h1>
      <Link to={'/Cartadd'}>
      ...
      {/* <div className="mfrst">
        <ButtonGroup aria-label="Basic example">
          <Button variant="secondary" > MICRO SWITCH</Button>
          <Button variant="secondary" > LEAF LEVER SWITCH</Button>
          <Button variant="secondary" >SEALED MICRO SWITCH</Button>
         
        </ButtonGroup>
      </div>
      <div>
        <h2 className="me">MICRO SWITCH</h2>
      ...
      <div>
        <h2 className="me">LEAF LEVER SWITCH</h2>
      ...
      <div>
        <h2 className="me">SEALED MICRO SWITCH</h2>
